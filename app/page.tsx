    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <main className="container mx-auto px-4 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-12">
            AI-powered insights from your lab results. Get personalized recommendations 
            to optimize your health based on your blood test data.
          </p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                ...
                <p className="text-sm text-gray-600 mb-2">
                  <span className="font-semibold">Below optimal.</span> May affect bone health and immune function.
                </p>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                ...
                <p className="text-sm text-gray-600 mb-2">
                  <span className="font-semibold">Elevated.</span> In the prediabetic range, but reversible.
                </p>
                <p className="text-sm text-blue-600 font-medium">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                ...
                <p className="text-sm text-gray-600 mb-2">
                  <span className="font-semibold">Optimal range.</span> Your "good" cholesterol is healthy.
                </p>
                <p className="text-sm text-blue-600 font-medium">
      ...
      <footer className="container mx-auto px-4 py-8 mt-20 border-t border-gray-200">
        <p className="text-center text-gray-600 text-sm">
          HealthScore AI is not a substitute for professional medical advice. 
